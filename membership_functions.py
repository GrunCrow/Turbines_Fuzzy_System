...
#                                                                INPUTS
#   Salinidad       (20, 50)
salinidad['Baja'] = fuzz.trimf(salinidad.universe, [20, 26, 33])
salinidad['Media'] = fuzz.trapmf(salinidad.universe, [30, 33, 37, 40])
salinidad['Alta'] = fuzz.trimf(salinidad.universe, [37, 45, 50])
...
corrientes['Alta'] = fuzz.trimf(corrientes.universe, [210, 255, 300])
...
densidad['Alta'] = fuzz.trimf(densidad.universe, [1025, 1050, 1100])
...
profundidad['Alta'] = fuzz.trimf(profundidad.universe, [4500, 6000, 7000])
...
profundidad_colocacion['Alta'] = fuzz.trimf(profundidad_colocacion.universe, [100, 125, 150])
