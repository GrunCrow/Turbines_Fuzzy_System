...
def calculate(input_salinity, input_temperature, input_currents, input_laminar_height, input_viscosity,
    ...
    simulation.input['laminar_height'] = float(input_laminar_height)
