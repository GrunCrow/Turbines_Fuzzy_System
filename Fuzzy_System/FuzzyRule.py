...
from Fuzzy_System.membership_functions import salinidad, temperatura, corrientes, altura_laminal, viscosidad, densidad, profundidad, \
...
r_no_recomendable_naranja = control.Rule((salinidad['Media']
                                          ...
                                          & ((temperatura['Media'] & densidad['Media'] & profundidad['Media']
                                              & ((corrientes['Baja'] & altura_laminal['Alta'] & viscosidad['Media'] & profundidad_colocacion['Media'])
                                                 | (corrientes['Alta'] & altura_laminal['Baja'] & viscosidad['Media'] & profundidad_colocacion['Media'])
                                                 | (corrientes['Alta'] & altura_laminal['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])
                                                 | (corrientes['Alta'] & altura_laminal['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))
                                             #  1 naranja + 1 amarillo
                                             | ((temperatura['Alta'] | temperatura['Baja']) & densidad['Media'] & profundidad['Media']    # temp amarillo
                                                & ((corrientes['Baja'] & altura_laminal['Alta'] & viscosidad['Media'] & profundidad_colocacion['Media'])   # corrientes nar
                                                   | (corrientes['Alta'] & altura_laminal['Baja'] & viscosidad['Media'] & profundidad_colocacion['Media'])     # alt_laminal nar
                                                   | (corrientes['Alta'] & altura_laminal['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])  # viscosidad nar
                                                   | (corrientes['Alta'] & altura_laminal['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))    # prof_coloc nar
                                             ...
                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Media'] & corrientes['Media']     # corrientes amarillo
                                                & ((altura_laminal['Baja'] & viscosidad['Media'] & profundidad_colocacion['Media'])   # alt_laminal nar
                                                    | (altura_laminal['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])  # viscosidad nar
                                                    | (altura_laminal['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))    # prof_coloc nar
                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Media'] & altura_laminal['Media']    # alt_laminal amarillo
                                                & ((corrientes['Baja'] & viscosidad['Media'] & profundidad_colocacion['Media'])   # corrientes nar
                                                    | (corrientes['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])  # viscosidad nar
                                                    | (corrientes['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))    # prof_coloc nar
                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Media'] & viscosidad['Baja']  # viscosidad amarillo
                                          ...
                                          | (((temperatura['Alta'] | temperatura['Baja']) & densidad['Baja'] & profundidad['Media']  # temperatura y densidad amarillo
                                             ...
                                             | ((temperatura['Alta'] | temperatura['Baja']) & densidad['Media'] & profundidad['Baja'] & altura_laminal['Media']  # temperatura y alt laminal amarillo
                                                & ((corrientes['Baja'] & viscosidad['Media'] & profundidad_colocacion['Media'])    # corrientes nar
                                                    | (corrientes['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])   # viscosidad nar
                                                    | (corrientes['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))     # prof_coloc nar
                                             | ((temperatura['Alta'] | temperatura['Baja']) & densidad['Baja'] & profundidad['Media'] & viscosidad['Baja']  # temperatura y viscosidad amarillo
                                                & ((corrientes['Baja'] & altura_laminal['Alta'] & profundidad_colocacion['Media'])    # corrientes nar
                                                    | (corrientes['Alta'] & altura_laminal['Baja'] & profundidad_colocacion['Media'])      # alt_laminal nar
                                                    | (corrientes['Alta'] & altura_laminal['Alta'] & profundidad_colocacion['Baja'])))     # prof_coloc nar
                                             ...
                                             | (temperatura['Media'] & densidad['Baja'] & profundidad['Baja'] & altura_laminal['Media']  # densidad y alt laminal amarillo
                                                & ((corrientes['Baja'] & viscosidad['Media'] & profundidad_colocacion['Media'])    # corrientes nar
                                                    | (corrientes['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])   # viscosidad nar
                                                    | (corrientes['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))     # prof_coloc nar
                                             | (temperatura['Media'] & densidad['Baja'] & profundidad['Media'] & viscosidad['Baja']  # densidad y viscosidad amarillo
                                                & ((corrientes['Baja'] & altura_laminal['Alta'] & profundidad_colocacion['Media'])    # corrientes nar
                                                    | (corrientes['Alta'] & altura_laminal['Baja'] & profundidad_colocacion['Media'])      # alt_laminal nar
                                                    | (corrientes['Alta'] & altura_laminal['Alta'] & profundidad_colocacion['Baja'])))     # prof_coloc nar
                                             ...
                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Baja'] & altura_laminal['Media']  # profundidad y alt laminal amarillo
                                                & ((corrientes['Baja'] & viscosidad['Media'] & profundidad_colocacion['Media'])    # corrientes nar
                                                    | (corrientes['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])   # viscosidad nar
                                                    | (corrientes['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))     # prof_coloc nar
                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Baja'] & viscosidad['Baja']  # profundidad y viscosidad amarillo
                                                & ((corrientes['Baja'] & altura_laminal['Alta'] & profundidad_colocacion['Media'])    # corrientes nar
                                                    | (corrientes['Alta'] & altura_laminal['Baja'] & profundidad_colocacion['Media'])      # alt_laminal nar
                                                    | (corrientes['Alta'] & altura_laminal['Alta'] & profundidad_colocacion['Baja'])))     # prof_coloc nar
                                             ...
                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Media'] & corrientes['Media'] & altura_laminal['Media']  # corrientes y alt laminal amarillo
                                                & ((altura_laminal['Alta'] & viscosidad['Muy Baja'] & profundidad_colocacion['Media'])   # viscosidad nar
                                                    | (altura_laminal['Alta'] & viscosidad['Media'] & profundidad_colocacion['Baja'])))     # prof_coloc nar
                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Baja'] & corrientes['Media'] & viscosidad['Baja']   # corrientes y viscosidad amarillo
                                                & ((corrientes['Alta'] & altura_laminal['Baja'] & profundidad_colocacion['Media'])      # alt_laminal nar
                                                    | (corrientes['Alta'] & altura_laminal['Alta'] & profundidad_colocacion['Baja'])))     # prof_coloc nar

                                             | (temperatura['Media'] & densidad['Media'] & profundidad['Media'] & altura_laminal['Media'] & viscosidad['Baja']  # alt laminal y viscosidad amarillo
...
r_no_recomendable_amarillos = control.Rule((~((salinidad['Alta'] | salinidad['Baja'])   # ningun rojo
                                            ...
                                            ~(corrientes['Baja'] | altura_laminal['Baja'] | viscosidad['Muy Baja'] |    # no algun naranja
...
r_descartada_naranjas = control.Rule(((corrientes['Baja'] & altura_laminal['Baja']) | (corrientes['Baja'] & viscosidad['Muy Baja']) |
...
r_descartada_naranja_amarillos = control.Rule(((corrientes['Baja'] | altura_laminal['Baja'] | viscosidad['Muy Baja'] | profundidad_colocacion['Baja']) &    # al menos un naranja
                                               (salinidad['Media'] &
